...
async function playRaceEngine(character1, character2){
    for (let round = 1; round <= 5; round++) {
        ...
        if (block === "RETA") {
            ...
            //character2.PONTOS -= powerResult1 > powerResult2 && character2.PONTOS > 0 ? 1 + console.log(`${character1.NOME} venceu o confronto!\n 
                //${character2.NOME} perdeu 1 ponto 🐢`) : 0 + console.log(powerResult1 > powerResult2 && character2.PONTOS === 0 ? `${character2.NOME} não perde ponto!`: "");
            

            //character1.PONTOS -= powerResult1 < powerResult2 && character1.PONTOS > 0 ? 1 + console.log(`${character2.NOME} venceu o confronto!\n 
                //${character1.NOME} perdeu 1 ponto 🐢`) : 0 + console.log(powerResult1 < powerResult2 && character1.PONTOS === 0 ? `${character1.NOME} não perde ponto!`: "");

            character2.PONTOS -= powerResult1 > powerResult2 && character2.PONTOS > 0 ? 1 : 0;
            if (powerResult1 > powerResult2 ){
                console.log(`${character1.NOME} ganhou o confronto`);
                if (character2.PONTOS === 0) {
                    console.log(`${character2.NOME} nao perde ponto`);
                } else {
            ...
            if (powerResult2 > powerResult1 ){
                console.log(`${character2.NOME} ganhou o confronto`);
                character1.PONTOS -= character1.PONTOS > 0 ? 1 & 
                console.log(`${character1.NOME} perde ponto`) : 0 & 
                console.log(`${character1.NOME} nao perde ponto`);
            ...
            //console.log(`pontos: ${character1.PONTOS} ${character2.PONTOS}`);
